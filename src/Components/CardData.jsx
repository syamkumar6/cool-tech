import image1 from "./../assets/images/glass.webp";
import image2 from "./../assets/images/aluPartition2.webp";
import image3 from "./../assets/images/kitchen.webp";
import image4 from "./../assets/images/showcase.webp";
import image6 from "./../assets/images/acp.webp";
import acpBg from "./../assets/images/acpBg.webp";
import glassBg from "./../assets/images/glassBg.webp";
import partitionBg from "./../assets/images/partitionBg.webp";
import netBg from "./../assets/images/netBg.webp";
import pleatedBg from "./../assets/images/pleatedBg.webp";
import showcaseBg from "./../assets/images/showcaseBg.webp";
import kitchenBg from "./../assets/images/kitchenBg.webp";
import windowBg from "./../assets/images/windowBg.webp";
import acp2 from "./../assets/images/acp2.webp";
import acp3 from "./../assets/images/acp3.webp";
import acp4 from "./../assets/images/acp4.webp";
import gImg1 from "./../assets/images/kitchen1.webp";
import partition2 from "./../assets/images/partition2.webp";
import glass3 from "./../assets/images/glass3.webp";
import net from "./../assets/images/netWindow.webp";
import pleated from "./../assets/images/pleated.webp";
import ward2 from "./../assets/images/ward2.webp";
import wpc from "./../assets/images/wpc.webp";
import tv from "./../assets/images/tv.webp";
import gImg2 from "./../assets/images/kitchen2.webp";
import gImg3 from "./../assets/images/kitchen3.webp";
import partition3 from "./../assets/images/partition3.webp";
import partition4 from "./../assets/images/partition4.webp";
import glass4 from "./../assets/images/glass4.webp";
import glass5 from "./../assets/images/glass6.webp";
import net2 from "./../assets/images/netWindow2.webp";
import net3 from "./../assets/images/netWindow3.webp";
import pleated2 from "./../assets/images/Pleated2.webp";
import pleated3 from "./../assets/images/pleated3.webp";
import ward from "./../assets/images/ward.webp";
import ward3 from "./../assets/images/ward3.webp";
import ward4 from "./../assets/images/ward4.webp";
import ward5 from "./../assets/images/ward5.webp";
import wpc2 from "./../assets/images/wpc2.webp";
import wpc3 from "./../assets/images/wpc3.webp";
import wpc4 from "./../assets/images/wpc4.webp";
import wpc5 from "./../assets/images/wpc5.webp";
import tv2 from "./../assets/images/tv2.webp";
import tv3 from "./../assets/images/tv3.webp";
import tv4 from "./../assets/images/tv4.webp";
import tvBg from "./../assets/images/tvBg.webp";
import wpcBg from "./../assets/images/wpcBg.webp";
import warBg from "./../assets/images/warBg.webp";
import ceiling1 from "./../assets/images/ceiling1.webp";
import ceiling2 from "./../assets/images/ceiling2.webp";
import ceiling3 from "./../assets/images/ceiling3.webp";
import ceiling4 from "./../assets/images/ceiling4.webp";
import alg1 from "./../assets/images/algeria1.webp";
import alg2 from "./../assets/images/algeria2.webp";
import alg3 from "./../assets/images/algeria3.webp";
import alg4 from "./../assets/images/algeria4.webp";
import pvc1 from "./../assets/images/pvc1.webp";
import pvc2 from "./../assets/images/pvc2.webp";
import pvc3 from "./../assets/images/pvc3.webp";
import pvcBG from "./../assets/images/pvcBg.webp";
import ceilingBg from "./../assets/images/ceilingBg.webp";
import prayer1 from "./../assets/images/prayer1.webp";
import prayer2 from "./../assets/images/prayer2.webp";
import prayer3 from "./../assets/images/prayer3.webp";
import prayerBg from "./../assets/images/prayerBg.webp";
...
const cardData = [
  ...
  },
  {
    ...
    title: "PVC Doors",
    description: [
     "Our PVC doors are the perfect blend of style, durability, and practicality, making them a great choice for both residential and commercial spaces. Crafted from high-quality polyvinyl chloride (PVC), these doors are lightweight, water-resistant, and designed to withstand daily wear and tear while maintaining their elegant appearance.",
  "Available in a variety of designs, colors, and textures, our PVC doors offer versatility to match any interior or exterior decor. They are termite-proof, weather-resistant, and require minimal maintenance, making them an economical and long-lasting solution. Whether you need them for bathrooms, kitchens, or any other area, PVC doors provide a sleek and modern finish with excellent functionality."
    ],
    gImg: [pvc1, pvc2, pvc3],
    id: 5,
    bNote: [
  ...
  },
  {
    ...
    title: "False Ceiling",
    description: [
     "Transform your spaces with our premium false ceiling solutions, designed to enhance both aesthetics and functionality. We offer a wide range of options, including POP, PVC, and grid ceilings, tailored to meet the unique needs of your home or office. Our expertly crafted designs not only elevate the visual appeal of your interiors but also provide improved acoustics and energy efficiency.",
  "Using high-quality materials and skilled craftsmanship, we ensure that each ceiling is durable, long-lasting, and easy to maintain. Whether you prefer the classic elegance of POP, the sleek and modern look of PVC, or the structured precision of grid ceilings, we deliver exceptional results that perfectly suit your style and budget."
    ],
    gImg: [ceiling4, ceiling3, ceiling2, ceiling1],
    id: 22,
    bNote: [
      "Weather Resistance",
      "Lightweight and Durable",
      ...
      "Customizable Designs to Match Any Style",
    ],
  },
  {
    img: alg2,
    bg: windowBg,
    title: "Algeria Windows and Doors",
    description: [
      "Enhance your spaces with our premium Algeria windows and doors, designed to combine functionality, durability, and modern aesthetics. We offer both normal open and sliding windows and doors to cater to diverse requirements, ensuring smooth operation and a stylish look that complements any interior or exterior design.",
  "Crafted using high-quality aluminium profiles, our windows and doors are rust-resistant, weatherproof, and built to last. They are designed for maximum ventilation, natural light, and easy maintenance. The sliding options are perfect for saving space and providing a seamless, modern appearance, while the normal open designs offer classic functionality and ease of use."
    ],
    gImg: [alg2, alg1, alg3, alg4],
    id: 33,
    bNote: [
  ...
  },
  {
    img: prayer3,
    bg: prayerBg,
    title: "Prayer Cabinets",
    description: [
      "Our aluminium prayer cabinets are thoughtfully designed to bring elegance, durability, and spirituality into your home. Crafted with high-quality aluminium, these cabinets are rust-resistant, sturdy, and require minimal maintenance, making them a long-lasting addition to your living space.",
